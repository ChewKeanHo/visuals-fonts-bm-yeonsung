# Baemin Yeonsung (`BM YEONSUNG`) Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Baemin Yeonsung is a Korean (ID: `KO`) calligraphic handwriting font designed by
[Woowa Brothers Corporation](http://www.woowahan.com).
It was inspired by the lettering on the cart of a vendor selling traditional
Korean pumpkin taffy (hobak yeot) on Jeju Island. This font may not have a lot
of flair, but each letter gives the feeling of having been painted with great
care, and there is something special about the rhythmical roughness in the
lines.

This font is ideal for informal Korean characters display be it eye-catching
headings or body text placed as banner, notices, writings, etc.
...
```
Title: Baemin Yeonsung (BM YEONSUNG) Font
Creators: Woowa Brothers Corporation
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-bm-yeonsung
UUID: 8D8675D0-CC2E-46EE-90C6-729F5F465B98
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-03-24
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-bm-yeonsung
```
